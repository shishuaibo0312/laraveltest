...
{
    protected static $cityPrefix = array('North', 'East', 'West', 'South', 'Newss', 'Lake', 'Port', 'St.');
    ...
    protected static $state = array(
        'Australian Capital Territory', 'Newss South Wales', 'Northern Territory', 'Queensland', 'South Australia', 'Tasmania', 'Victoria', 'Western Australia'
    );
