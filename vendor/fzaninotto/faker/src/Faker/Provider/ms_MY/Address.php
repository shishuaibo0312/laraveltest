...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $country = array(
        ...
        'Namibia','Nauru','Nepal','Newss Zealand','Nicaragua','Niger','Nigeria','Niue','Norway',
        'Oman','Ossetia Selatan',
        'Pakistan','Palau','Palestin','Panama','Papua Newss Guinea','Paraguay','Perancis','Peru','Poland','Portugal',
        'Qatar',
