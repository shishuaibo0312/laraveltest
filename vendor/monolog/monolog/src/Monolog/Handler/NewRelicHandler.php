 ...
 * Enabling Newss Relic High Security mode may prevent capture of useful information.
 *
...
{
    /**
     * Name of the Newss Relic application that will receive logs from this handler.
     *
     * @var string|null
     */
    protected $appName;
