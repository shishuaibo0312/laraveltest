    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('/admin/fodderadd')}}">素材添加</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">新闻素材</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('/new/add')}}">新闻素材添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('/new/show')}}">新闻素材展示</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('/channel/channeladd')}}">渠道添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('/channel/channelshow')}}">渠道展示</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('/channel/channelchart')}}">图表展示</a> <li>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('/menu/menuadd')}}">菜单添加</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('/menu/menushow')}}">菜单展示</a>
                            </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="{{url('index_v1')}}" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
